...
_C.MODEL.DA_HEADS.HAA_LOSS_P3 = 0.05
_C.MODEL.DA_HEADS.HAA_LOSS_P4 = 0.06
_C.MODEL.DA_HEADS.HAA_LOSS_P5 = 0.1
_C.MODEL.DA_HEADS.HAA_LOSS_P6 = 0.06
_C.MODEL.DA_HEADS.HAA_LOSS_P7 = 0.05

# 0 is ce loss 1 is focal loss
_C.MODEL.DA_HEADS.IMG_LOSS_TYPE = 0 
_C.MODEL.DA_HEADS.GCR_LOSS = True
_C.MODEL.DA_HEADS.GCR_LOSS_WEIGHT = 0.1
_C.MODEL.DA_HEADS.ICA_LOSS = True
_C.MODEL.DA_HEADS.ICA_LOSS_WEIGHT = 0.1
# ---------------------------------------------------------------------------- #
# Center Besidgement Loss option
# ---------------------------------------------------------------------------- #
_C.MODEL.DA_HEADS.CBL_LOSS = True
_C.MODEL.DA_HEADS.CB_LOSS_WEIGHT = 1.0
