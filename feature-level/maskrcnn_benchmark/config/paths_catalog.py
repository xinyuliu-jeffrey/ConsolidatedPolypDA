...
class DatasetCatalog(object):
    ...
    DATASETS = {
        "gfda_cocostyle": {
            "img_dir": "polyps/GFDA_imgs",
            "ann_file": "polyps/augcvc/annotations/instances_train2017.json"
        },
        "etis_psuedo_cocostyle": {
            "img_dir": "polyps/ETIS_png",
            "ann_file": "polyps/ETIS_png_cocostyle_psuedo.json"
        },
        "etis_cocostyle": {
            "img_dir": "polyps/ETIS_png",
            "ann_file": "polyps/ETIS_png_cocostyle.json"
        },
        "coco_2017_train": {
